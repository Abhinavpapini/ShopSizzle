    ...
    <div className="min-h-screen">
      ...
      <div className="container py-12">
        <div className="text-center mb-10">
          <h1 className="text-4xl font-extrabold bg-gradient-to-r from-primary to-purple-400 bg-clip-text text-transparent mb-2">About ShopSizzle</h1>
          ...
          <ol className="relative border-l-2 border-primary pl-6">
            <li className="mb-8">
              ...
              <div className="ml-8">
                ...
                <p className="text-muted-foreground">ShopSizzle started as a vision to make online shopping delightful.</p>
              </div>
            </li>
            <li className="mb-8">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg shadow p-6">
              <p className="italic mb-2">"ShopSizzle is the fastest and most beautiful shopping site I've ever used!"</p>
        ...
        <div className="text-center py-8">
          <h2 className="text-3xl font-extrabold mb-2">Ready to experience ShopSizzle?</h2>
